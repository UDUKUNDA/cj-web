...
export function CreateAccount() {
  return (
    <section className="w-full relative px-4 md:px-6 flex justify-center py-20 lg:py-0 lg:pb-24 bg-[#E6FFFB]">
      <div className="w-full max-w-[1440px] flex justify-center">
          
        <div 
          className="bg-[#004D40] rounded-[40px] mt-[60px] lg:mt-[65px] relative w-full lg:w-[1338.57px] min-h-[450px] lg:min-h-[200px] lg:h-[260.95px] flex items-center z-10"
        >
