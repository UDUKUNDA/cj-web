...
export function LoanOptionsSection() {
  const tableContent = (
    <div className="flex h-full w-full flex-col">
      {/* Restored your original grid-cols structure for perfect alignment */}
      <div className="grid min-h-0 flex-1 grid-cols-[calc(100%/6)_calc(5*100%/6)]">
        
        {/* LEFT COLUMN (Labels) - Added Sticky Logic */}
        <div className="sticky left-0 z-20 flex h-full flex-col bg-white shadow-[4px_0_8px_-4px_rgba(0,0,0,0.1)] lg:shadow-none">
          ...
          <div className="grid w-full flex-1 grid-cols-5 grid-rows-5">
            ...
            {[
              ...
              row.map((value, colIndex) => {
                ...
                const textColor = "text-[#1D5E5A] font-inter font-bold";
                ...
                if (rowIndex === 0 && typeof value === "string" && value.startsWith("RWF ")) {
                  content = (
                    <>
    ...
    <section className="w-full bg-[#E6FFFB]">
      <div className="mx-auto w-full max-w-[1512px]">
        ...
        <div className="lg:hidden px-4 py-10">
          ...
          {/* This container allows horizontal scroll */}
          <div className="mt-8 overflow-x-auto scrollbar-hide">
            {/* Added relative here to ensure sticky child works */}
            <div className="loanOptionsMobileTable min-w-[760px] relative">
              {tableContent}
            </div>
          </div>
        ...
        <div className="hidden lg:block relative w-full aspect-[1512/1305.7]">
          ...
          <div className="absolute z-10 text-center text-black font-inter font-medium" style={{left: "50%", top: "6.04%", width: "min(840px, 72%)", transform: "translateX(-50%)", fontSize: "36px", lineHeight: "40px"}}>
            Credit Jambo offers multiple loan options
          </div>
          <div className="absolute text-center text-black/80 font-inter font-normal" style={{left: "50%", top: "11.45%", width: "min(560px, 58%)", transform: "translateX(-50%)", fontSize: "20px", lineHeight: "28px"}}>
            Choose the loan type that matches your needs, from covering daily expenses to growing your business.
          </div>
          <div className="absolute" style={{left: "5.40%", top: "18.85%", width: "88.23%", height: "42.20%"}}>
            {tableContent}
          </div>
          <div className="absolute" style={{left: "5.40%", top: "71.10%", width: "90.00%", height: "29.40%"}}>
            <CreateAccountforbusiness embedded />
          </div>
        </div>
      </div>
